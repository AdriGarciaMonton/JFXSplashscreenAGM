...
public class Controlador {
	...
	public void initialize() {
		TranslateTransition translateTransition = new TranslateTransition(Duration.seconds(0.1), logoAGM);
		...
		TranslateTransition translateTransition00 = new TranslateTransition(Duration.seconds(0.1), labelDescri);
		translateTransition00.setByY(700);
		translateTransition00.play();

		translateTransition.setOnFinished(event -> {

			TranslateTransition translateTransition1 = new TranslateTransition(Duration.seconds(1.5), logoAGM);
			...
			translateTransition1.setOnFinished(event1 -> {
				...
				TranslateTransition translateTransition11 = new TranslateTransition(Duration.seconds(1.5), labelNombre);
				...
				translateTransition11.setOnFinished(event2 -> {
					...
					TranslateTransition translateTransition111 = new TranslateTransition(Duration.seconds(1.5),
							labelDescri);
					...
					translateTransition111.setOnFinished(event3 -> {
						...
						fadeTransition.setOnFinished(event4 -> {
							...
							FadeTransition fadeTransition1 = new FadeTransition(Duration.seconds(2), anchorPane);
